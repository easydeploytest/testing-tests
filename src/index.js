...
const BASE_DOMAIN   = process.env.BASE_DOMAIN || 'easydeploy.sandbox.dxm.digitalrealty.com';
const ARGOCD_URL    = process.env.ARGOCD_URL    || 'https://argocd.' + BASE_DOMAIN;
const INFISICAL_URL = process.env.INFISICAL_URL || 'https://infisical.' + BASE_DOMAIN;
const GRAFANA_URL   = 'https://shanzindlr.grafana.net';
const PORTAL_URL    = process.env.PORTAL_URL    || 'https://portal-dev.' + BASE_DOMAIN;
const DEV_URL       = 'https://' + APP + '-dev.' + BASE_DOMAIN;
const PROD_URL      = 'https://' + APP + '.' + BASE_DOMAIN;
